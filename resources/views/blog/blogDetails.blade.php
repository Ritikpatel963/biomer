    ...
    <div class="col-lg-8">
        ...
        <div class="card p-0 radius-12 overflow-hidden">
            <div class="card-body p-0">
                ...
                {{-- Thumbnail --}}
                @if($blog->thumbnail)
                    <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt="{{ $blog->thumbnail_alt_text }}"
                    ...
                    @forelse ($recentBlogs as $post)
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('blogDetails', $post->id) }}" class="blog__thumb w-100 radius-12 overflow-hidden">
                                <img src="{{ $post->thumbnail_url }}" alt="{{ $post->thumbnail_alt_text }}" class="w-100 h-100 object-fit-cover">
                            </a>
